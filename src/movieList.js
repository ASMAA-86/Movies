  ...
  render() {
    const movies = [
      ...
      },
      {
        ...
        poster:
          "https://m.media-amazon.com/images/M/MV5BMjE2MTIwNjg0MV5BMl5BanBnXkFtZTcwNjAxODIzMw@@._V1_UX182_CR0,0,182,268_AL_.jpg",
      ...
      },
      {
        ...
        poster:
          "https://m.media-amazon.com/images/M/MV5BMTU5Nzg2OTk2NF5BMl5BanBnXkFtZTYwNTc1ODM3._V1_UX182_CR0,0,182,268_AL_.jpg",
    ...
    const movieComponant = movies.map(movie => {
      return <Movie movie={movie} />; //obj send to movie
    });
